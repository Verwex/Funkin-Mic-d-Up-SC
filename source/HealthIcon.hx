...
class HealthIcon extends FlxSprite
{
	...
	public function new(char:String = 'bf', isPlayer:Bool = false)
	{
		...
		animation.add('senpai-angry', [25, 26], 0, false, isPlayer);
		animation.add('spirit', [27, 28], 0, false, isPlayer);
		animation.add('bf-old', [14, 15], 0, false, isPlayer);
		animation.add('gf', [16, 17], 0, false, isPlayer);
		animation.add('gf-car', [16, 17], 0, false, isPlayer);
		animation.add('gf-christmas', [16, 17], 0, false, isPlayer);
		animation.add('gf-pixel', [16, 17], 0, false, isPlayer);
